...
using Service.EducationTimeApi.Modules;
using Service.Web;
using SimpleTrading.ServiceStatusReporterConnector;

namespace Service.EducationTimeApi
{
	public class Startup
	{
		private const string DocumentName = "education/time";
		private const string ApiName = "EducationTimeApi";
