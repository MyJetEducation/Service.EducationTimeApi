...
using Service.WalletApi.EducationTimeApi.Controllers.Contracts;
using Service.WalletApi.EducationTimeApi.Mappers;
using Service.Web;

namespace Service.WalletApi.EducationTimeApi.Controllers
{
	[Route("/api/v1/education/time")]
	public class EducationController : BaseController
	{
		private readonly IGrpcServiceProxy<ITutorialTimeService> _tutorialService;

		public EducationController(IGrpcServiceProxy<ITutorialTimeService> tutorialService,
